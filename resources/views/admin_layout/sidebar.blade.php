            ...
            <section class="sidebar">
               <ul class="sidebar-menu">
                  ...
                  <li class="treeview {{request()->is('admin/settings') ? 'active' : ''}}">
                     ...
                     <ul class="treeview-menu {{request()->is('admin/size') || request()->is('admin/color')||request()->is('admin/country')
                      ...
                      ? 'active' : ''}}">
                        ...
                        <li><a href="{{url('/admin/shippingcoast')}}"><i class="fa fa-circle-o"></i> Shipping Cost</a></li>
                        <li><a href="{{url('/admin/toplevelcategory')}}"><i class="fa fa-circle-o"></i> Top Level Category</a></li>
                        <li><a href="{{url('/admin/middlelevelcategory')}}"><i class="fa fa-circle-o"></i> Mid Level Category</a></li>
                  ...
                  <li class="treeview {{request()->is('admin/registercustomer') ? 'active' : ''}}">
                     <a href="{{url('/admin/registercustomer')}}">
