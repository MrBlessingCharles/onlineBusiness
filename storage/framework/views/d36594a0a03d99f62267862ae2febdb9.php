                     ...
                     <div class="row">
                        <div class="col-md-5">
                           <ul class="prod-slider">
                              <li style="background-image: url(<?php echo e(asset('frontend/assets/uploads/product-featured-86.jpg')); ?>);">
                                 <a class="popup" href=" <?php echo e(asset('frontend/assets/uploads/product-featured-86.jpg')); ?>"></a>
                              </li>
                              <li style="background-image: url(<?php echo e(asset('frontend/assets/uploads/product_photos/112.jpg')); ?> );">
                                 <a class="popup" href="<?php echo e(asset('frontend/assets/uploads/product_photos/112.jpg')); ?> "></a>
                              </li>
                              <li style="background-image: url(<?php echo e(asset('frontend/assets/uploads/product_photos/113.jpg')); ?> );">
                                 <a class="popup" href="<?php echo e(asset('frontend/assets/uploads/product_photos/113.jpg')); ?> "></a>
                              </li>
                           </ul>
                           <div id="prod-pager">
                              <a data-slide-index="0" href="">
                                 <div class="prod-pager-thumb" style="background-image: url(<?php echo e(asset('frontend/assets/uploads/product-featured-86.jpg')); ?> )"></div>
                              </a>
                              <a data-slide-index="1" href="">
                                 <div class="prod-pager-thumb" style="background-image: url(<?php echo e(asset('frontend/assets/uploads/product_photos/112.jpg')); ?>)"></div>
                              </a>
                              <a data-slide-index="2" href="">
                                 <div class="prod-pager-thumb" style="background-image: url(<?php echo e(asset('frontend/assets/uploads/product_photos/113.jpg')); ?>)"></div>
                              </a>
                           </div>
                        </div>
                        <div class="col-md-7">
