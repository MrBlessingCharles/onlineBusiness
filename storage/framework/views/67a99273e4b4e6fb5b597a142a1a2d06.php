...
<?php $__env->startSection('content'); ?>
 <!-- ********************* start content ******************** -->
	  <!-- start banner -->
      <div class="page-banner" style="background-image: url(asset('assets/uploads/faq-banner.jpg')}});">
         <div class="inner">
            <h1>FAQ</h1>
         </div>
      </div>
...
<?php echo $__env->make('Client_layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\basiclessons\resources\views/client/faq.blade.php ENDPATH**/ ?>