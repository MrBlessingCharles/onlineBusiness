                  ...
                  <form action="" method="post">
                     ...
                     <div class="cart">
                        <table class="table table-responsive table-hover table-bordered">
                           ...
                           <tr>
                              <td>1</td>
                              <td>
                                 <img src="assets/uploads/product-featured-86.jpg" alt="">
                              </td>
                     ...
                     <div class="cart-buttons">
                        <ul>
                           ...
                           <li><a href="<?php echo e(url('/')); ?>" class="btn btn-primary">Continue Shopping</a></li>
                           <li><a href="<?php echo e(url('checkout')); ?>" class="btn btn-primary">Proceed to Checkout</a></li>
                        </ul>
                     </div>
                  </form>
               </div>
...
<?php echo $__env->make('Client_layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\basiclessons\resources\views\Client\cart.blade.php ENDPATH**/ ?>