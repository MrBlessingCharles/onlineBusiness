      ...
      <div class="content-wrapper">
         <section class="content-header">
            <div class="content-header-left">
               <h1>View top level category</h1>
            </div>
            <div class="content-header-right">
               <a href="<?php echo e(url('admin/addtoplevelcategory')); ?>" class="btn btn-primary btn-sm">Add New</a>
            </div>
         </section>
                        ...
                        <table id="example1" class="table table-bordered table-hover table-striped">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td><?php echo e($toplevelcategory->tcat_name); ?></td>
                                 <td><?php echo e($toplevelcategory->show_on_menu); ?></td>

                                 <td style="display: flex;">
                                    <a href="<?php echo e(url('admin/edittoplevelcategory', [$toplevelcategory->id])); ?>" class="btn btn-primary btn-xs">Edit</a>
                                    <!-- <a href="#" class="btn btn-danger btn-xs" data-href="size-delete.php?id=1" data-toggle="modal" data-target="#confirm-delete">Delete</a> -->
                                    <form action="<?php echo e(url('admin/deletetoplevelcategory', [$toplevelcategory->id])); ?>" method="post">
                                       <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin_layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\basiclessons\resources\views/admin/toplevelcategory.blade.php ENDPATH**/ ?>