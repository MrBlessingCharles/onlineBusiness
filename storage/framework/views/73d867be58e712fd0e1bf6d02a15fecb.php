 <script src="<?php echo e(asset('backend/js/jquery-2.2.4.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('backend/js/jquery.inputmask.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/js/jquery.inputmask.date.extensions.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/js/jquery.inputmask.extensions.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('backend/js/icheck.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('backend/js/jquery.fancybox.pack.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/js/app.min.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/js/jscolor.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/js/on-off-switch.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/js/on-off-switch-onload.js')); ?>"></script>
        <script src="<?php echo e(asset('backend/js/clipboard.min.js')); ?>"></script>
...
</script><?php /**PATH C:\xampp\htdocs\basiclessons\resources\views\admin_layout\script.blade.php ENDPATH**/ ?>